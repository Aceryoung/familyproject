                                ...
                                return (
                                    <article key={post.id} className="relative bg-gray-50 rounded-2xl p-4 flex gap-4 border border-gray-100 group">
                                        ...
                                        <Link href={`/post/${post.id}`} className="flex flex-grow min-w-0 pr-2 col-span-2 group/link cursor-pointer">
                                            {isLoadingUrls ? (
                                                <div className="flex-shrink-0 w-24 h-24 rounded-xl mr-4 skeleton" />
                                            ) : thumbnailUrl ? (
                                                ...
                                                <div className="flex-shrink-0 w-24 h-24 rounded-xl bg-gray-100 flex items-center justify-center mr-4">
                                        ...
                                        <div className="flex flex-col items-end justify-center pl-2 border-l border-gray-100 gap-2 flex-shrink-0 w-14">
                                            <Link 
